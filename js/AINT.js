...
function stepSix () {
	...
	$('#step6').append("<div class=\"alert alert-block\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button><span class=\"label label-important\">Important</span>  Please select Yes or No. </div>");	
		...
		$('#insertHere').append('<p><i class="icon-flag"></i>  Step 6: Your HDA <strong class = "text-error" >cannot access</strong> the <span class="highlight">internet</span> (ping test failed).</p>');
		$('#step6').collapse('hide');
